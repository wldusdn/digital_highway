...
const Frame6 = () => {
  ...
  return (
    <div className="w-full relative bg-white h-[932px] overflow-hidden text-left text-5xl text-black font-inter">
      ...
      <div
        className="absolute top-[282px] left-[0px] w-[430px] h-[207px] cursor-pointer"
      ...
      >
        ...
        <div className="absolute top-[22px] left-[23px]">말왕족발 부경점</div>
        <img
          className="absolute top-[19px] left-[194px] w-[35px] h-[35px] object-cover"
          alt=""
          src="/star@2x.png"
        />
        <div className="absolute top-[22px] left-[232px]">5.0</div>
        <img
      ...
      <div className="absolute top-[242px] left-[26px] text-xl">정렬</div>
      <div className="absolute top-[235px] left-[80px] w-[68px] h-[33px] text-sm">
      ...
      <div className="absolute top-[235px] left-[165px] w-[68px] h-[33px] text-sm">
        <div className="absolute top-[0px] left-[0px] rounded-3xs bg-whitesmoke-100 w-[68px] h-[33px]" />
        <div className="absolute top-[8px] left-[8px]">배달방식</div>
      </div>
      <div className="absolute top-[235px] left-[250px] w-[68px] h-[33px] text-sm">
        <div className="absolute top-[0px] left-[0px] rounded-3xs bg-whitesmoke-100 w-[68px] h-[33px]" />
        <div className="absolute top-[8px] left-[21px]">쿠폰</div>
      </div>
      <div className="absolute top-[235px] left-[335px] w-[68px] h-[33px] text-sm">
        <div className="absolute top-[0px] left-[0px] rounded-3xs bg-whitesmoke-100 w-[68px] h-[33px]" />
