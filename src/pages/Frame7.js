...
const Frame7 = () => {
  ...
  return (
    <div className="w-full relative bg-white h-[932px] overflow-y-auto text-left text-5xl text-black font-inter">
      ...
      />
      <div
        className="absolute top-[286px] left-[133px] cursor-pointer"
      ...
      <div
        className="absolute top-[447px] left-[24px] w-[381px] h-10 cursor-pointer text-xl text-white"
        onClick={onGroupContainerClick}
      >
        <div className="absolute top-[0px] left-[0px] rounded-3xs bg-mediumaquamarine w-[381px] h-10" />
        <div className="absolute top-[7px] left-[62px]">
          2000원 첫주문 할인 쿠폰 받기
        </div>
      </div>
