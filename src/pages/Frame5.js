...
const Frame5 = () => {
  ...
  return (
    <div className="w-full relative bg-white h-[932px] overflow-hidden text-left text-5xl text-black font-inter">
      ...
      <div className="absolute top-[240px] left-[26px] text-xl">정렬</div>
      ...
      <div className="absolute top-[499px] left-[0px] w-[430px] h-[207px]">
        <div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] rounded-3xs bg-white" />
        <div className="absolute top-[22px] left-[23px]">시민족발 부경점</div>
        <img
          className="absolute top-[19px] left-[194px] w-[35px] h-[35px] object-cover"
          alt=""
          src="/star@2x.png"
        />
        <div className="absolute top-[22px] left-[232px]">4.9</div>
        <img
          className="absolute h-[57.97%] w-[27.91%] top-[33.82%] right-[67.44%] bottom-[8.21%] left-[4.65%] rounded-3xs max-w-full overflow-hidden max-h-full object-cover"
          alt=""
          src="/rectangle-13@2x.png"
      ...
      <div className="absolute top-[716px] left-[0px] w-[430px] h-[207px]">
        <div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] rounded-3xs bg-white" />
        <div className="absolute top-[22px] left-[23px]">야웅족발 부경점</div>
        <img
          className="absolute top-[19px] left-[194px] w-[35px] h-[35px] object-cover"
          alt=""
          src="/star@2x.png"
        />
        <div className="absolute top-[22px] left-[232px]">4.8</div>
        <img
          className="absolute h-[57.97%] w-[27.91%] top-[33.82%] right-[67.44%] bottom-[8.21%] left-[4.65%] rounded-3xs max-w-full overflow-hidden max-h-full object-cover"
          alt=""
          src="/rectangle-13@2x.png"
      ...
      <div className="absolute top-[368px] left-[0px] rounded-3xs bg-whitesmoke-100 w-[430px] h-[564px]" />
      <div className="absolute top-[397px] left-[193px] text-center">정렬</div>
      <div
        className="absolute top-[883px] left-[194px] text-center cursor-pointer"
        onClick={onText6Click}
      >
        닫기
      </div>
      <div className="absolute top-[466px] left-[39px] flex flex-col items-start justify-center gap-[30px] text-center">
        <div className="relative">배달 빠른 순</div>
        <div className="relative">배달팁 낮은 순</div>
        <div className="relative text-mediumaquamarine">기본 순</div>
        <div className="relative">주문 많은 순</div>
        <div className="relative">별점 높은 순</div>
        <div className="relative">가까운 순</div>
        <div className="relative">찜 많은 순</div>
      </div>
      <img
        className="absolute top-[584px] left-[363px] w-[30px] h-[30px] object-cover"
        alt=""
        src="/done@2x.png"
      />
    </div>
